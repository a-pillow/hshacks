...
export default function Navbar() {
    ...
    return (
        <nav className="w-full py-2 px-12 mb-6 flex justify-between items-center">
            <a href="/" className="text-3xl text-brand-primary font-bold border-2 border-brand-primary px-2 py-1 cursor-pointer hover:bg-brand-primary hover:text-brand-background hover:border-brand-primary hover:-translate-y-[2px] hover:drop-shadow-lg duration-150 rounded-lg">
                pawsitive
            </a>
